...
void BoundingBox::clusters_callback(const camera3d_xyzrgb::ClustersArray::ConstPtr& clusters_msg){
...
void BoundingBox::getBBox(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cluster, int j, visualization_msgs::Marker &marker, visualization_msgs::Marker &text_marker, camera3d_xyzrgb::BoundingBox3D &bbox){
